 ...
 */
public class Jcapturedialog extends javax.swing.JDialog implements
		ActionListener {
	...
	public Jcapturedialog(JFrame frame) {
		...
		try {
			...
			getContentPane().setLayout(thisLayout);
			{
				...
				jPanel_west.setLayout(new BoxLayout(jPanel_west,
						BoxLayout.Y_AXIS));
				getContentPane().add(jPanel_west);
				{
					...
					// netPanel.setPreferredSize(new java.awt.Dimension(239,
					// 56));
					{
			...
			}
			{
				...
				jPanel_east.setLayout(new BoxLayout(jPanel_east,
						BoxLayout.Y_AXIS));
				getContentPane().add(jPanel_east);

				{
					caplenPanel = new JPanel();
					caplenPanel.setBorder(BorderFactory
							.createTitledBorder("最长字长"));
					caplenPanel.setAlignmentX(Component.LEFT_ALIGNMENT);
					jPanel_east.add(caplenPanel);
					caplenPanel.setLayout(new BoxLayout(caplenPanel,
							BoxLayout.Y_AXIS));
